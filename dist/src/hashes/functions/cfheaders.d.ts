 ...
 */
export declare function cfilterHeaderChain(prev: BytesLike, filterHashes: BytesLike | BytesLike[]): Uint8Array;
/**
 ...
 */
export declare function cfilterVerify(filter: BytesLike, prev: BytesLike, expected: BytesLike): boolean;
