 ...
 */
export function siphash24(key, data) {
 ...
 */
export function siphash24Hex(key, data) {
 ...
 */
export function siphash24WithKeys(k0, k1, data) {
    return BigInt(hashesProvider.hashes.siphash24WithKeys(k0.toString(), k1.toString(), toBytes(data)));
}
/**
 ...
 */
export function siphash24Many(k0, k1, items) {
    const digests = hashesProvider.hashes.siphash24Many(k0.toString(), k1.toString(), items.map(toBytes));
