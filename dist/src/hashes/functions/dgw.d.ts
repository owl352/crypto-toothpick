import { DgwParams } from '../types.js';
/**
 ...
 */
export declare function dgwNextBitsRange(times: Uint32Array | number[], nbits: Uint32Array | number[], contextBlocks: number, params?: DgwParams): Uint32Array;
